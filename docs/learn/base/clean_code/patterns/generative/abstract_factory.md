...
Предоставляет интерфейс для создания семейства взаимосвязанных или взаимозависимых объектов, не специфицируя их
конкретных классов.
...
<blockquote>
Представьте себе ресторан и его кулинарный опыт. 

Для создания итальянского ресторана нам нужны: 

<ul>
    <li>Итальянский шеф-повар</li>
    <li>Итальянская кухня</li>
    <li>Итальянский персонал</li>
</ul>

Тогда как для японского ресторана потребуются 

<ul>
    <li>Японский шеф-повар</li>
    <li>Японская кухня</li>
    <li>Японский персонал</li>
</ul>

Каждый ресторан имеет свои уникальные элементы, и между ними существует взаимозависимость для создания определенного кулинарного опыта. 
</blockquote>

Другими словами:

<blockquote>
    Абстрактная фабрика группирует отдельные, но связанные/зависимые фабрики вместе без указания их конкретных классов.
</blockquote>
...
- Упрощает замену семейства продуктов:
  ...
  Класс конкретной фабрики появляется в приложении только единожды: при создании экземпляра, что облегчает замену
  используемой приложением конкретной фабрики.
